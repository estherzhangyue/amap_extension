...
class AMapController {
  ...
  void _connectStreams(int mapId) {
    ...
    if (_mapState.widget.onRouteSearchDone != null) {
      _methodChannel
          .onRouteSearchDone(mapId: mapId)
          .listen(((MapRouteSearchDoneEvent e) => _mapState.widget.onRouteSearchDone!(e.value)));
    }
  ...
  Future<dynamic> searchRoute() {
    return _methodChannel.searchRoute(mapId: mapId);
  }
  /// 清空缓存
